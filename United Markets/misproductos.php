...
<body>
    ...
    <div class="contenido">
        ...
        <div class="productos">
            ...
            $datos = mysqli_query($conexion, "SELECT * FROM productos WHERE id_cliente={$_SESSION['id']}");
            if ($datos->num_rows > 0) {
            ...
            ?>
                    <div class="producto">
                        ...
                        <div class="container">
                            ...
                            <div class="row">
                                <a href="documentos/php/eliminarProducto.php?id=<?php echo $row['id'] ?>" class="btn btn-danger eliminar">Eliminar</a>
                                <a href="#" onclick="editar(<?php echo $row['id'] ?>)" class="btn btn-primary eliminar">Editar</a>
                            </div>
                        </div>
                    </div>
            <?php
            ...
            ?>
            <a href="agregarProducto.php" class="btn btn-success btn-block btn_comprar">Añadir Producto</a>
        </div>
    </div>
